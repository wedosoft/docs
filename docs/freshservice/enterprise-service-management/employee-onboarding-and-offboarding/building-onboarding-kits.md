...
Freshservice의 온보딩 키트 구축을 통해 역할별 맞춤형 온보딩 자료 패키지 생성을 수행할 수 있습니다.
...
:::warning 설정 시 주의사항
온보딩 키트 설정 설정 변경 시 기존 진행 중인 프로세스에 영향을 줄 수 있습니다. 변경 전 충분한 검토와 테스트를 수행하세요.
:::

### 설정 화면

![설정 화면 1](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50001714689/original/426ndfRfu9ONw2JxGSw3JvGDp0_nz7t_TA.png?1599746952)

![설정 화면 2](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50001284417/original/WctyNtMPJE3zagYxgotLEEIukfPABQGdGw.png?1592396522)

![설정 화면 3](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50004160115/original/wNF7d0FNfpaQn7xKbHj5ZQKPwGQE98bYWA.png?1637061301)
...
### 상황 1: 대기업 환경에서의 활용
**목표**: 대규모 조직에서의 체계적인 온보딩 키트 설정 구현
**방법**: 
...
### 상황 3: 원격 근무 환경에서의 활용
**목표**: 비대면 환경에서도 효과적인 온보딩 키트 설정 제공
**방법**:
...
온보딩 키트 설정을 더욱 효율적으로 활용하기 위한 고급 설정:
...
:::warning 라이선스 요구사항
온보딩 키트 구축 기능은 Pro 또는 Enterprise 플랜에서만 사용 가능합니다.
:::

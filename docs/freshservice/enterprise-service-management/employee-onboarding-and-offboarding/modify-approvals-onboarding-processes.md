...
Freshservice의 온보딩 승인 프로세스 수정을 통해 온보딩 승인 단계와 규칙을 조직에 맞게 커스터마이징을 수행할 수 있습니다.
...
2. **'온보딩 승인 프로세스 수정'** 메뉴 또는 설정 옵션 선택
3. 필요한 권한 및 설정 권한 확인
...
:::warning 설정 시 주의사항
승인 워크플로 관리 설정 변경 시 기존 진행 중인 프로세스에 영향을 줄 수 있습니다. 변경 전 충분한 검토와 테스트를 수행하세요.
:::

### 설정 화면

![설정 화면 1](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50001284519/original/z0lF_BbUccfrKPgusRMgmU830ptKGfEyKg.png?1592397359)
...
### 상황 1: 대기업 환경에서의 활용
**목표**: 대규모 조직에서의 체계적인 승인 워크플로 관리 구현
**방법**: 
...
**목표**: 제한된 리소스로 효과적인 승인 워크플로 관리 실현
**방법**:
...
### 상황 3: 원격 근무 환경에서의 활용
**목표**: 비대면 환경에서도 효과적인 승인 워크플로 관리 제공
**방법**:
...
승인 워크플로 관리을 더욱 효율적으로 활용하기 위한 고급 설정:
...
:::warning 라이선스 요구사항
온보딩 승인 프로세스 수정 기능은 Pro 또는 Enterprise 플랜에서만 사용 가능합니다.
:::

...
Freshservice의 온보딩/오프보딩 양식 위임을 통해 온보딩/오프보딩 양식 처리 권한을 다른 사용자에게 위임을 수행할 수 있습니다.
...
2. **'온보딩/오프보딩 양식 위임'** 메뉴 또는 설정 옵션 선택
3. 필요한 권한 및 설정 권한 확인
...
:::warning 설정 시 주의사항
권한 위임 설정 설정 변경 시 기존 진행 중인 프로세스에 영향을 줄 수 있습니다. 변경 전 충분한 검토와 테스트를 수행하세요.
:::

### 설정 화면

![설정 화면 1](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50010346105/original/BZVYS14KFlcktT6cVSXiSLo5ixqTUH_6BQ.png?1702285996)

![설정 화면 2](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50010346106/original/qYl6h0JiAl1A0Br9YOccqlSVlOMfblmOMQ.png?1702285997)

![설정 화면 3](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50010346103/original/J9rsBS03e7ifg2oWV7tCTuXygAnBLrTN4A.png?1702285995)
...
권한 위임 설정을 더욱 효율적으로 활용하기 위한 고급 설정:
...
:::warning 라이선스 요구사항
온보딩/오프보딩 양식 위임 기능은 Pro 또는 Enterprise 플랜에서만 사용 가능합니다.
:::

...
Freshservice의 온보딩 이해관계자 추가을 통해 온보딩 프로세스에 참여할 주요 이해관계자 설정을 수행할 수 있습니다.
...
:::warning 설정 시 주의사항
이해관계자 관리 설정 변경 시 기존 진행 중인 프로세스에 영향을 줄 수 있습니다. 변경 전 충분한 검토와 테스트를 수행하세요.
:::

### 설정 화면

![설정 화면 1](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50001296481/original/a2w52is0TEkX18RzT8PtjHUFQuiV3yQuTA.png?1592504762)

![설정 화면 2](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50001284356/original/DoVS_oLxljVaQFBXqtbirCi-odu23uPOOw.gif?1592396207)

![설정 화면 3](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/50001284350/original/aNFe07_QLzyAsflzuJ7oSBJxcIdd1PQWtw.png?1592396191)


### 단계별 설정 가이드

**1단계**: 2. I have added a field to a stakeholder in employee onboarding but cannot add it to a ticket.

**2단계**: 4. How do I add a checklist or checkbox to the parent ticket for onboarding? In Global Settings/Admin , navigate to Employee Onboarding &gt; Add Stakeholder.
...
이해관계자 관리을 더욱 효율적으로 활용하기 위한 고급 설정:
...
:::warning 라이선스 요구사항
온보딩 이해관계자 추가 기능은 Pro 또는 Enterprise 플랜에서만 사용 가능합니다.
:::

---
title: "사용자 정의 메트릭 및 사용자 정의 속성"
description: "Freshservice Analytics에서 사용자 정의 메트릭과 속성을 생성하고 활용하는 방법을 알아보세요."
---

# 사용자 정의 메트릭 및 사용자 정의 속성

이 문서는 Freshservice Analytics에서 조직의 특별한 요구사항에 맞는 사용자 정의 메트릭과 속성을 생성하고 활용하는 방법을 설명합니다.
